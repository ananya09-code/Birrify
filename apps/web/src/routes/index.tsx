...
const BANKS = [
  ...
  { name: "Dashen Bank", short: "DASH", buy: 144.8, sell: 147.1, change: 1.61 },
  {
    name: "Awash Bank",
    short: "AWASH",
    buy: 144.55,
...
function buildHistory(days, start, seed) {
...
function SectionLabel({ kicker, title, description }) {
  return (
...
const navLink = { color: COLORS.textSoft, textDecoration: "none" };
const navCta = {
  background: COLORS.blue,
  color: "#fff",
  border: "none",
...
function DashboardPreview() {
  ...
  return (
    ...
    >
      ...
      >
        {[
          { label: "Best Buy", value: bestBuy.toFixed(2), color: COLORS.green },
          { label: "Best Sell", value: bestSell.toFixed(2), color: COLORS.red },
          { label: "Market Average", value: avg, color: COLORS.text },
        ].map((cell, i) => (
          <div
            key={cell.label}
            style={{
          ...
          >
            <div
              style={{ fontSize: 11, color: COLORS.textFaint, fontWeight: 600 }}
            >
              {cell.label}
            </div>
            <div
...
function Hero() {
  return (
    <section
      id="rates"
      style={{ maxWidth: 1140, margin: "0 auto", padding: "68px 24px 84px" }}
    >
      <div
        style={{
          display: "grid",
        ...
        >
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <XAxis
                dataKey="date"
                tick={{ fontSize: 11.5, fill: COLORS.textFaint }}
              ...
              <Tooltip
                ...
                formatter={(v) => [`${v} ETB`, "Market average"]}
              />
              <Line
                type="monotone"
                dataKey="rate"
      ...
      >
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div style={{ paddingTop: 22, color: COLORS.textFaint }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={inputWrap}>
                <span
                  style={{ ...inputStyle, fontWeight: 600, color: COLORS.text }}
                >
    ...
    <section style={{ borderTop: `1px solid ${COLORS.border}` }}>
      ...
      >
        <div>
          ...
          <p style={{ fontSize: 14.5, color: COLORS.textSoft, margin: 0 }}>
      ...
      >
        <div>
          ...
          >
            ...
            <span
              style={{ fontWeight: 600, fontSize: 13.5, color: COLORS.text }}
            >
              Birrify
            </span>
          </div>
...
export default function BirrifyLanding() {
  return (
    <div
      style={{
        background: `
          radial-gradient(700px 420px at 78% 0%, rgba(37,99,235,0.08), transparent 65%),
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        @media (max-width: 860px) {
          .birrify-hero-grid { grid-template-columns: 1fr !important; }
          .birrify-feature-grid { grid-template-columns: 1fr !important; gap: 28px !important; }
          .birrify-feature-grid > div { border-left: none !important; padding-left: 0 !important; }
          .birrify-nav-links { display: none !important; }
        }
